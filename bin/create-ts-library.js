...
const tsPackageJson = require('./templates/packageJsons/ts-library.json');

const argv = yargs(hideBin(process.argv))
  .command('$0 <packageName>', 'Add a new TS library to the monorepo', yargs => {
...
async function createTsLibrary() {
  ...
  try {
    ...
    await executeCommand(`cp -rf ${__dirname}/templates/ts-library-base/ ./${dirName}`);
